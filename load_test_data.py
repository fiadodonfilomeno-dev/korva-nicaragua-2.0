...
products_data = [
    ...
    {'name': 'Empaques biodegradables al por mayor', 'description': 'Cajas y empaques ecológicos para alimentos y productos. Precios por mayor, entrega en Managua.', 'price': 500, 'currency': 'NIO', 'category': 'compras', 'whatsapp': '+50587654321', 'owner': 'panaderia_nicaraguena', 'image_url': '/static/img/real/product-empaque.jpg', 'image': 'product-empaque.jpg'},
    {'name': 'Packaging personalizado para PyMEs', 'description': 'Diseño e impresión de cajas, bolsas y etiquetas con tu marca. Mínimo 100 unidades.', 'price': 1500, 'currency': 'NIO', 'category': 'compras', 'whatsapp': '+50588887777', 'owner': 'tech_solutions', 'image_url': '/static/img/real/product-packaging.jpg', 'image': 'product-packaging.jpg'},
    {'name': 'Envíos y logística a nivel nacional', 'description': 'Servicio de mensajería y paquetería para PyMEs. Entregas en Managua, León, Granada y más.', 'price': 120, 'currency': 'NIO', 'category': 'compras', 'whatsapp': '+50587123456', 'owner': 'artesanias_esteli', 'image_url': '/static/img/real/product-shipping.jpg', 'image': 'product-shipping.jpg'},
    {'name': 'Materia prima para cerámica artesanal', 'description': 'Arcilla, pigmentos naturales y herramientas para cerámica. Venta por mayor en Estelí.', 'price': 300, 'currency': 'NIO', 'category': 'compras', 'whatsapp': '+50587123456', 'owner': 'artesanias_esteli', 'image_url': '/static/img/real/product-cafe.jpg', 'image': 'product-cafe.jpg'},
]
