...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # El perfil es creado automáticamente por la señal create_user_profile.
            # Lo recuperamos y actualizamos con los datos del formulario.
            profile = user.profile
            profile.business_name = form.cleaned_data['business_name']
            profile.city = form.cleaned_data['city']
            profile.sector = form.cleaned_data['sector']
            profile.ruc = form.cleaned_data['ruc']
            profile.save()
            
            # La configuración de IA se crea automáticamente por la señal de Profile.
            # Nos aseguramos de que exista mediante get_or_create.
